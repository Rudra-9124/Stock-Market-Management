...
class PaymentSystem1 {
    ...
    void CashPayment() {
        System.out.println("Paid " + amt1 + " INR by cash.");
    }
    ...
    void Credit() {
        ...
        while (flag1) {
            ...
            if (cvv.length() == 3) {
                flag1 = false;
                System.out.println("Paid " + amt1 + " INR by Credit card.");
            } else {
    ...
    void Debit()
    {
        ...
        while (flag1) {
            ...
            if (cvv.length() == 3) {
                flag1 = false;
                System.out.println("Paid " + amt1 + " INR by Debit card.");
            } else {
                System.out.println("Enter correct CVV!!");
                temp++;
                if (temp == 3) {
    ...
    void UPI()
    {
        ...
        sc.nextInt();
        System.out.println("Paid " + amt1 + " INR by UPI.");
    }
}